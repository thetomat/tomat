...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .command-category, .section-header');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    commands.forEach(command => {
        command.addEventListener('mouseenter', () => {
            command.style.transform = 'scale(1.05) rotate(2deg)';
        });
        
        command.addEventListener('mouseleave', () => {
            command.style.transform = 'scale(1) rotate(0deg)';
        });
    });
});
...
// Console easter egg
console.log(`
🔥 Shockwave Discord Bot 🔥
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Built with ❤️ and modern web technologies
Ready to power up your Discord server!

Invite the bot: https://discord.com/oauth2/authorize?client_id=YOUR_BOT_ID&scope=bot&permissions=8
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
`);
